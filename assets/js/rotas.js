...
  const novaLista = rotaListaDiv.cloneNode(false);
  while (rotaListaDiv.firstChild) {
    novaLista.appendChild(rotaListaDiv.firstChild);
  }
  rotaListaDiv.parentNode.replaceChild(novaLista, rotaListaDiv);


  Object.defineProperty(window, "_rotaListaDivAtual", { value: novaLista, configurable: true });
...
  const pontos = [];
  const lista = document.getElementById("rotaListaPontos");
